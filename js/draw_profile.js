$(document).ready(function () {
    ...
    if(localStorage.getItem("profile_data")){
        ...
        data_profile.company_name ? $("#input4").val(data_profile.company_name)  : $("#input4").val("")
        ...
        $("#video_div").empty();
        $("#video_div").append("<video  width=\"400\"  height=\"200\" \"400\" id=\"video_player\"  controls controlsList=\"nodownload\">\n" +
        ...
        if(data_profile.new_video_path && data_profile.new_video_path != ""){
            ...
            $("#new_video_div").empty();
            $("#new_video_div").append("<video  width=\"400\"  height=\"200\" \"400\" id=\"video_player\"  controls controlsList=\"nodownload\">\n" +
